...
describe('Asset Battery Chart View Verification', () => {
	...
	it('Verify Solar Chart is Displayed', () => {
		...
		solarTooltipsYAxes.forEach((tooltip, i) => {
			...
			cy.get('g circle').eq(i).should('have.attr', 'style')
				.and('contain', 'rgb(231, 141, 58)');
