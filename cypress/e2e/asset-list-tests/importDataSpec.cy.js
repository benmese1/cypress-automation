...
describe('Asset Management import verification', () => {
    ...
    const csvHeader = 'Company Name,Asset ID,Asset Name,Device ID,Device IP,Latitude,Longitude,Ambient Temp,Internal Temp,Asset Type,Address,Trip Status,Dwell Time,Battery Power,Stale Time,Asset Tags\r\n'
