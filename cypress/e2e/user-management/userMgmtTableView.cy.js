describe('Verify User management table view', () => {
	...
	it('Verify user management table columns visibility in table view', () => {
		...
		const columnsHeaderList = ['Company/Sub Company','Last Name','First Name','Username','Email','Phone Number','Role','Last Login Date','Created Date','Status','Created Date','Updated Date']
	...
	it('Get organization name for the associated user logged', () => {
		...
		cy.get('[data-testid="page"]')
			...
			.get('[data-testid="page"] h3').then(function ($elem) {
