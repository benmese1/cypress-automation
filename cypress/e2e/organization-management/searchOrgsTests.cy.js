...
describe('Search functionality in Organization management', () => {
    ...
    it('Search organization by providing Parent Company', () => {
        ...
        //Verify that results are probably based search
        cy.get('[data-testid="column-header-parent-company"]')
            .should('be.visible');
		cy.get("[role='cell'][data-field='parent_company'] div")
			.each(($item) => {
	...
	it('Search organization by providing Timezone', () => {
        ...
        //Verify that results are probably based search
        cy.get('[data-testid="column-header-timezone"]')
            .should('be.visible');
		cy.get("[role='cell'][data-field='time_zones'] div")
			.each(($item) => {
